  ...
  return (
    <div className="pt-16">
      <SEO
        ...
        description="Save on Marsa Alam excursions! Family packages 15% off, early bird 10% discount, combo deals."
        canonical="https://seashelltrips.com/offers"
      />
      <section className="section-padding">
        <div className="container-tour">
          <h1 className="font-display text-4xl md:text-5xl font-bold text-center text-foreground mb-4">{t("offers_title")}</h1>
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              {offers.map((o) => (
                <div key={o.id} className="relative bg-card rounded-xl p-8 shadow-card border border-border overflow-hidden">
                  ...
                  <a href={getWhatsAppLink()} target="_blank" rel="noopener noreferrer"
                    ...
                    <MessageCircle className="h-4 w-4" /> Claim Offer
                  </a>
                </div>
              ))}
            </div>
